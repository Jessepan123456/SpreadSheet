...
namespace FormulaEvaluationGradingTests;
...
///            Jim de St. Germain
///            Travis Martin
/// Date:      Updated Fall 2025 for .net 9.0
...
public class GradingTestsPs4
{
    ...
    public void Evaluate_SingleNumber_Equals5( )
    {
        ...
        Assert.AreEqual( 5.0, formula.Evaluate( _ => 0 ) );
    }
    ...
    public void Evaluate_SingleVariable_EqualsLookup( )
    {
        ...
        Assert.AreEqual( 13.0, formula.Evaluate( _ => 13 ) );
        Assert.AreEqual( 20.0, formula.Evaluate( _ => 20 ) );
        Assert.AreEqual( -1.0, formula.Evaluate( _ => -1 ) );
    }
    ...
    public void Evaluate_AdditionOperator_Equals8( )
    {
        ...
        Assert.AreEqual( 8.0, formula.Evaluate( _ => 0 ) );
    }
    ...
    public void Evaluate_VariablePlusValue_Equals8( )
    {
        ...
        Assert.AreEqual( 8.0, formula.Evaluate( _ => 6 ) );
    }
    ...
    public void Evaluate_LowerCaseVariable_Equals100( )
    {
        ...
        Assert.AreEqual( 100.0, formula.Evaluate( _ => 50 ) );
    }
    ...
    {
        Formula formula = new("2+X1");
        var result = formula.Evaluate( _ => throw new ArgumentException( "Unknown variable" ) );
    ...
    public void Evaluate_ParenthesesAfterTimes_Equals100( )
    {
        ...
        Assert.AreEqual( 100.0, formula.Evaluate( _ => 0 ) );
    }
    ...
    public void Evaluate_DirectDivideByZero_FormulaError( )
    {
        ...
        var result = formula.Evaluate( _ => 0 );
        Assert.IsInstanceOfType( result, typeof( FormulaError ) );
    }
    ...
    public void Evaluate_TestComplexNestedParensRight_Equals6( )
    {
        ...
        Assert.AreEqual( 6.0, formula.Evaluate( _ => 1 ) );
    }
    ...
    {
        Formula formula = new( "((((x1+x2)+x3)+x4)+x5)+x6" );
        Assert.AreEqual( 12.0, formula.Evaluate( _ => 2 ) );
    }
    ...
    public void Evaluate_RepeatedVarWithVariousOperators_Equals3( )
    {
        ...
        Assert.AreEqual( 3.0, formula.Evaluate( _ => 3 ) );
    }
    ...
    public void Evaluate_SeparateStacks_StacksClearedEachTimeAndEquals15( )
    {
        ...
        Assert.AreEqual( 15.0, formula.Evaluate( _ => 0 ) );
        Assert.AreEqual( 15.0, formula.Evaluate( _ => 0 ) );
    }
    ...
    public void Evaluate_FormulasAreIndependent_Equal15_14_11( )
    {
        ...
        Assert.AreEqual( 15.0, formula1.Evaluate( _ => 0 ) );
        Assert.AreEqual( 14.0, formula2.Evaluate( _ => 0 ) );
        Assert.AreEqual( 11.0, formula3.Evaluate( _ => 0 ) );
    }
    ...
    {
        Formula formula = new( "2*6+3" );
        Assert.AreEqual( 15.0, formula.Evaluate( _ => 100 ) );
    }
    ...
    public void Evaluate_ComputePiStress_PiTo4DecimalPlaces( )
    {
        ...
        double result = (double) f.Evaluate( _ => 0 );
    ...
    /// <summary>
    ///   Test the not equals operator on two different objects with different values.
    /// </summary>
    [TestMethod]
    [Timeout( 2000, CooperativeCancellation = true)]
    [TestCategory( "40" )]
    ...
    {
        Assert.Throws<FormulaFormatException>(() => new Formula( "xx" ));
    }
    ...
    public void FormulaToString_CreatesEqualFormula_EqualEachOther( )
    {
        ...
        Assert.AreEqual( f1.Evaluate( _ => 0 ), f2.Evaluate( _ => 0 ) );
